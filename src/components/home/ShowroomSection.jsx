...
const BRANCHES = [
  {
    name: "Nairobi Branch",
    address: ["Whitehouse Flats, Donholm", "Along Outering Road", "Near Topgear Driving School", "Nairobi, Kenya"],
    mapsUrl: "https://www.google.com/maps/search/Whitehouse+Flats+Donholm+Nairobi",
          ...
          >
            ...
            <div className="flex items-center gap-4 p-5 rounded-2xl border border-white/10 bg-white/5">
              ...
              <div>
                ...
                <a href="tel:+254110767199" className="text-white font-semibold text-lg hover:text-gold transition-colors">
                  0110 767 199
                </a>
              </div>
            </div>
