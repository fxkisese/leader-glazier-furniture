...
values
  ('show_pricing', 'true', 'boolean', 'Display pricing on website'),
  ('hide_unavailable', 'false', 'boolean', 'Hide out-of-stock items'),
  ('enable_instant_quotes', 'true', 'boolean', 'Enable real-time quote calculation'),
  ('enable_whatsapp', 'true', 'boolean', 'Enable WhatsApp integration'),
  ('show_installation_option', 'true', 'boolean', 'Offer installation services'),
  ('company_phone', '+254700000000', 'text', 'WhatsApp contact number')
